...
public static class StringExtensions {
	...
	public static double? AsDouble(this string @this, NumberStyles numberStyles, IFormatProvider? formatProvider = null) {
		IFormatProvider cultureInfo = formatProvider ?? CultureInfo.InvariantCulture;
	...
	public static bool IsEmptyOrOnlyWhiteSpace(this string? @this) => @this != null && (@this.Length == 0 || string.IsNullOrWhiteSpace(@this));
	...
	public static string NotNullOrEmpty(this string? @this, string? errorMessage = null) => @this.NotNullOrEmpty(_ => errorMessage ?? $"String is {(@this == null ? "null" : "empty")}.");
	...
	public static string ToValidPath(this string @this, string? spaceReplaceValue = null, string? replaceValue = null) {
		...
		var invalidChars = _invalidFileNameChars.Value;
