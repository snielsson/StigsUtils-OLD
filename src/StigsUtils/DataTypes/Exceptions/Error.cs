...
public static class ErrorExtensions {
	public static Error<T> Error<T>(this T @this, string? message = null, [CallerMemberName] string? callerName = null, [CallerFilePath] string? callerFilePath = null, [CallerLineNumber] int callerLineNumber = 0) => new(@this, message) {
