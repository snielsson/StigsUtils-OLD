...
public static class StringBuilderExtensions {
	...
	public static StringBuilder Truncate(this StringBuilder @this, Size count) {
		if (count >= @this.Length) return @this.Clear();
		@this.Remove(@this.Length - count, count.Value);
		return @this;
	}
}