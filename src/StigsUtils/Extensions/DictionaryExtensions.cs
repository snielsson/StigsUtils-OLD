...
public static class DictionaryExtensions {
	...
	public static TValue? ValueOrDefault<TKey, TValue>(this IReadOnlyDictionary<TKey, TValue> @this, TKey key) => @this.TryGetValue(key, out TValue? val) ? val : default;

	public static TValue? ValueOrDefault<TKey, TValue>(this IDictionary<TKey, TValue> @this, TKey key) => @this.TryGetValue(key, out TValue? val) ? val : default;
